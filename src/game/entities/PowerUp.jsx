...
export default function PowerUp() {
  return (
    <div className="relative w-14 h-14 animate-float" aria-hidden>
      <svg viewBox="0 0 60 60" className="w-full h-full drop-shadow-[0_0_10px_rgba(106,146,245,0.85)]">
        <defs>
          <radialGradient id="powerupGlow" cx="50%" cy="45%" r="60%">
            <stop offset="0%" stopColor="#fef1b0" stopOpacity="0.9" />
            <stop offset="100%" stopColor="#6a92f5" stopOpacity="0" />
          </radialGradient>
        ...
        <path
          ...
          strokeWidth="2.5"
        />
        <path d="M30 16 L30 44" stroke="#fef1b0" strokeWidth="1.5" opacity="0.7" />
        <path d="M30 24 Q38 26 30 34 Q22 26 30 24 Z" fill="#fef1b0" opacity="0.85" />
      </svg>
    </div>
  )
}
